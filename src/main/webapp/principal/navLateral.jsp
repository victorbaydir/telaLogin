...
<nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                          <a href="<%= request.getContextPath()%>/principal/usuarioCadastro.jsp" class="waves-effect waves-dark">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="principal/usuarioCadastro.jsp" class="waves-effect waves-dark">
